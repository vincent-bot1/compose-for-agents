...
+ If you're using Docker Engine or Docker Desktop on Windows, ensure that the [Docker Model Runner requirements](https://docs.docker.com/ai/model-runner/) are met and the necessary drivers are installed
